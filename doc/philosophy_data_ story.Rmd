...
summary(lm)
```
The result of linear regression shows that there is a significant positive relation between sentiment score and mean sentence length, which means, a more positive book tends to have longer sentences.\
